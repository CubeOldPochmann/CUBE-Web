...
const SobreCompleto = props => (
    <div>
        ...
        <h4>
            ...
            O site possuirá um layout simples, no qual o usuário irá criar uma conta no site, nos permitindo melhor controle. Após a criação da conta, o usuário terá acesso a todos os materiais disponíveis para o seu aprendizado.
        </h4>
    </div>
)

export default SobreCompleto